...
public class CartViewHolder extends RecyclerView.ViewHolder {
    ...
    public CartViewHolder(@NonNull View itemView, CartAdapter cartAdapter, Context context) {
        ...
        tv_title = itemView.findViewById(R.id.tv_cart_product_name);
        tv_price = itemView.findViewById(R.id.tv_product_price);
        tv_quantity = itemView.findViewById(R.id.tv_quantity);
        iv_image = itemView.findViewById(R.id.imageView);
        btn_delete = itemView.findViewById(R.id.btn_cart_delete);
        ...
        btn_minus.setOnClickListener(quantityChange);
